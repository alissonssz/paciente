...
router.use(
  "/bootstrap-switch",
  express.static("./node_modules/bootstrap-switch/dist/")
);
...
router.use(
  "/autocomplete",
  express.static("./node_modules/devbridge-autocomplete/dist/")
);
router.use("/vue", express.static("./node_modules/vue/dist/"));
router.use(
  "/vue-resource",
  express.static("./node_modules/vue-resource/dist/")
);
...
router.use(
  "/moment-timezone",
  express.static("./node_modules/moment-timezone/")
);
